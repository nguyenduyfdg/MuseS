...
public class LightArtifactAdapter extends ArrayAdapter<ArtifactView> {

    private Activity activity;
    private int resource;
    private List<ArtifactView> objects;

    public LightArtifactAdapter(@NonNull Activity activity, @LayoutRes int resource, @NonNull List<ArtifactView> objects) {
